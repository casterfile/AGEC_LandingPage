...
public class RaisehandGestureListener : MonoBehaviour, KinectGestures.GestureListenerInterface
{
	...
	private static RaisehandGestureListener instance = null;
	...
	private bool raiseLeftHand = false;
	...
	public static RaisehandGestureListener Instance
	{
		get
		{
			return instance;
